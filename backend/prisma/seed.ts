...
async function seed() {
    ...
    data: [
      {
        ...
        name: "Admin",
        email: "sudo@sudo.com",
        password: "$2y$10$WorZIDZfX1vJp.9Wy5tyTOq0o0xQxVtJ1N33l2XSDhGL5SjOAQOT6",
        phone: "123456",
        user_type_id: 1,
        branch_id: 1,
        createdOn: new Date(),
    ...
    data: [
      {
        ...
        max_weight: 400,
        available: true,
        driver_id: "USR-78abd298-2eaa-4867-998e-a295e9c94c4e",
        branch_id: 1,
      },
      {
        id: 2,
  ...
  await prisma.parcels.create({
    data: {
      ...
      client_id: "USR-0f2196b7-dc8d-4e81-a4c3-34c374fc4e4f",
